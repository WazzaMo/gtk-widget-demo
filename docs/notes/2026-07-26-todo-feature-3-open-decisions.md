...
Closed — 2026-07-29. Both items below were resolved during Feature 3
...
decisions 1–6 are resolved in dated plan notes under `docs/notes/`. Two items
...
Both formerly open decisions were closed during Feature 3 delivery
(2026-07-29):
...
Follow-on refinements (dynamic title, tree sidebar) are optional and not
blockers for Feature 3 acceptance.
